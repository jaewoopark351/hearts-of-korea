...
> 2026-09-22 후속 적용: 현재 총345개(기존326+공산 경제정책10+후속 내정9). 현재 구성·좌표·검증 상태는 [2차 확장 기록](HOK_KOREAN_SECOND_WAVE_PLAN.md)을 따른다. 아래326개 좌표·화면 관측은 이전 기준선 이력이며 후속 추가분의 게임 검증 결과가 아니다.
