...
> 2026-09-22 후속 적용: 현재 총336개(기존326+공산 경제정책10). 현재 구성·좌표·검증 상태는 [2차 확장 기록](HOK_KOREAN_SECOND_WAVE_PLAN.md)을 따른다. 아래326개 좌표·화면 관측은 이전 기준선 이력이며 새10개와 이번 이동의 게임 검증 결과가 아니다.
